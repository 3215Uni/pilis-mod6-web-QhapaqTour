...
export const Main = () => {
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M0 82.7289L60 50.4999C118 25.5 250 -16.5374 370 7.49998C490 31.5374 600 88.7382 720 112.776C840 136.813 960 88.7382 1080 82.7289C1200 76.7195 1320 112.776 1380 130.804L1440 148.832V160H1380C1320 160 1200 160 1080 160C960 160 840 160 720 160C600 160 480 160 360 160C240 160 120 160 60 160H0V82.7289Z" fill="white"/>
</svg>
    </div>
    <main>
    <div className="personales">
        ...
        <div className='lista'>
            <img src={Message} alt="message" style={{"width": "1em","height":"1em"}} srcset="" />
            <p>Mensaje</p>
        </div>
        <div className='lista'>
            <FaMoneyBill />
